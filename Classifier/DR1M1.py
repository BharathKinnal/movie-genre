...
for j in Num:
	...
	if(not (os.path.exists(os.path.join('../MovieScraper/TestPosters','p_'+str(j)+'.jpeg')))):
		continue
	feature1,ht1,st1,et1=ft.getFeat(os.path.join('../MovieScraper/TestPosters','p_'+str(j)+'.jpeg'))
	#print len(et1)
	ht1=np.float32(ht1)
